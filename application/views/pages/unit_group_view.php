<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="col-m-2">
        ...
        <button class="btn btn-success" onclick="add_unit_group()"><i class="glyphicon glyphicon-plus"></i> Add Unit Group</button>
    </div>
...
function detail(unit_groupid) {
    window.location = "<?php echo base_url(); ?>index.php/unit/index/"+unit_groupid;
}
